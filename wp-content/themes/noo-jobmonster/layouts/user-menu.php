	...
	<li class="menu-item-has-children nav-item-member-profile login-link align-right">
		...
		<ul class="sub-menu">
			...
			<?php elseif(Noo_Member::is_candidate()):?>
				...
				<li class="menu-item" ><a href="<?php echo Noo_Member::get_endpoint_url('manage-resume')?>" style="white-space: nowrap;"><i class="fa fa-file-text-o"></i> <?php _e('Manage Resume','noo')?></a></li>
