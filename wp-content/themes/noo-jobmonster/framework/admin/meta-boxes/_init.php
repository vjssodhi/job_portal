...
// // 2.3 Portfolio Meta Boxes
// if( NOO_SUPPORT_PORTFOLIO ) {
// 	require_once( NOO_META_BOXES . '/portfolio-meta-boxes.php' );
// }

// 2.4 Product Meta Boxes
if( NOO_WOOCOMMERCE_EXIST ) {
	require_once( NOO_META_BOXES . '/product-meta-boxes.php' );
}
// 2.5 Testimonial Meta Boxes
