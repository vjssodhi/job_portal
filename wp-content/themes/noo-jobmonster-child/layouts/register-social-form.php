		...
		<div class="form-group row">
			<div class="col-sm-9">
				<div class="form-control-flat">
					<label class="radio" for="<?php echo $prefix; ?>_user_role_1" ><input id="<?php echo $prefix; ?>_user_role_1" type="radio" name="user_role" value="employer" checked=""><i></i><?php esc_html_e('Registration For Company','noo')?></label>
					<label class="radio" for="<?php echo $prefix; ?>_user_role_2" ><input id="<?php echo $prefix; ?>_user_role_2" type="radio" name="user_role" value="candidate" checked=""><i></i><?php esc_html_e('Registration For Recruiter','noo')?></label>
				</div>
			</div>
		</div>
